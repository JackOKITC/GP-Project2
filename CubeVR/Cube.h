...
static const GLfloat vertices[] =
{
	...
	1.00f,  0.00f,  1.00f,	// [2]	// ( 2)
	-1.00f,  0.00f,  1.00f,	// [3]	// ( 3)

	// Top Face
	-1.00f,  0.00f,  1.00f,	// [3]	// ( 4)
	1.00f,  0.00f,  1.00f,	// [2]	// ( 5)
	1.00f,  0.00f, -1.00f,	// [6]	// ( 6)
	-1.00f,  0.00f, -1.00f,	// [7]	// ( 7)

	// Back Face
	1.00f, -1.00f, -1.00f,	// [5]	// ( 8)
	-1.00f, -1.00f, -1.00f, // [4]	// ( 9)
	-1.00f,  0.00f, -1.00f,	// [7]	// (10)
	1.00f,  0.00f, -1.00f,	// [6]	// (11)
	...
	-1.00f,  0.00f,  1.00f, // [3]	// (18)
	-1.00f,  0.00f, -1.00f, // [7]	// (19)

	// Right Face
	1.00f, -1.00f,  1.00f, // [1]	// (20)
	1.00f, -1.00f, -1.00f, // [5]	// (21)
	1.00f,  0.00f, -1.00f, // [6]	// (22)
	1.00f,  0.00f,  1.00f, // [2]	// (23)
};
...
static const GLfloat groundColors[] = {
	...
	// Top Face
	0.5f, 0.0f, 0.5f, 1.0f, // [3]	// ( 4)
	0.5f, 0.0f, 0.5f, 1.0f, // [2]	// ( 5)
	0.5f, 0.0f, 0.5f, 1.0f, // [6]	// ( 6)
	0.5f, 0.0f, 0.5f, 1.0f, // [7]	// ( 7)
